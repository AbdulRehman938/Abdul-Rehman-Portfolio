...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      <Sparkles className="w-5 h-5 text-[#41ECFF]" />
  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      <div className="absolute -inset-6 opacity-[25%] z-0 hidden sm:block">
        <div className="absolute inset-0 bg-gradient-to-r from-[#41ECFF] to-[#41ECFF] rounded-full blur-2xl animate-spin-slower" />
        <div className="absolute inset-0 bg-gradient-to-l from-[#41ECFF] to-[#41ECFF] rounded-full blur-2xl animate-pulse-slow opacity-50" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#41ECFF] to-[#41ECFF] rounded-full blur-2xl animate-float opacity-50" />
      </div>
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-4">
              ...
              <a href="#Portofolio">
                <button className="sm:px-6 py-2 sm:py-3 rounded-lg border border-[#41ECFF]/50 text-[#41ECFF] font-medium transition-all duration-300 hover:scale-105 flex items-center gap-2 hover:bg-[#41ECFF]/10">
