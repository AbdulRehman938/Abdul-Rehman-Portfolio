...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/abdul-rehman-50a117342/",
  ...
  },
  {
    ...
    subText: "@iam.abdul21",
    icon: Instagram,
    url: "https://www.instagram.com/iam.abdul21/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "YouTube",
    subText: "@AbdulRehman2128",
    icon: Youtube,
    url: "https://www.youtube.com/@ARehman2128",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "GitHub",
    subText: "@AbdulRehman938",
    icon: Github,
    url: "https://github.com/AbdulRehman938",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-emerald-900/10 to-blue-900/5 rounded-2xl p-6 py-8 backdrop-blur-xl border border-white/10">
      <h3
        className="text-xl font-semibold text-white mb-6 flex items-center gap-2"
        data-aos="fade-down"
      >
        <span className="inline-block w-8 h-1 bg-gradient-to-r from-emerald-400 to-blue-400 rounded-full"></span>
        Connect With Me
      </h3>
