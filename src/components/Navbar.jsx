        ...
        <div className="flex items-center justify-between h-16">
            ...
            <div className="ml-8 flex items-center space-x-8">
              {navItems.map((item) => (
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#41ECFF] to-[#1BA5B0] transform origin-left transition-transform duration-300 ${
                      activeSection === item.href.substring(1)
                        ? "scale-x-100"
          ...
          <div className="md:hidden">
            <button
              ...
              className={`relative p-2 text-[#e0f7ff] hover:text-white transition-transform duration-300 ease-in-out transform ${
